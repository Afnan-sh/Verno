...
exports.EnhancedSidebarProvider = void 0;
...
class EnhancedSidebarProvider {
    workspaceRoot;
    static viewType = 'verno-enhanced-sidebar';
    _view;
    logger;
    todoService;
    feedbackService;
    ...
    constructor(workspaceRoot) {
        ...
        this.logger = new logger_1.Logger('EnhancedSidebar');
    ...
    initializeServices() {
        ...
        this.conversationService = new conversation_1.ConversationService(this.workspaceRoot);
    }
    ...
    sendTodosToWebview() {
        if (!this._view || !this.todoService)
            return;
        try {
            ...
            this.logger.error('Error sending TODOs', error);
        }
    }
    sendFeedbackToWebview() {
        if (!this._view || !this.feedbackService)
            return;
    ...
    sendConversationsToWebview() {
        if (!this._view || !this.conversationService)
            return;
...
exports.EnhancedSidebarProvider = EnhancedSidebarProvider;
function getNonce() {
    let text = '';
...
//# sourceMappingURL=EnhancedSidebarProvider.js.map