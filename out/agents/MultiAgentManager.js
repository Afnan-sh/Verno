...
class MultiAgentManager {
    ...
    constructor(logger, agentRegistry, llmService, fileService) {
        ...
        this.progressIndicator = new progress_1.ProgressIndicator();
    }
    /**
    ...
    async runPipeline(context, stagesOverride) {
        const outputs = {};
        // Default stages
        ...
        for (const stage of stages) {
            ...
            try {
                const result = await agent.execute(enrichedContext);
...
//# sourceMappingURL=MultiAgentManager.js.map